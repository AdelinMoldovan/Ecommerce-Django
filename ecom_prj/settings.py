...
ALLOWED_HOSTS = ['.railway.app', 'web-production-368e.up.railway.app', '*']
#ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['http://127.0.0.1', 'https://*.ngrok-free.app', 'https://fastcart.up.railway.app', 'https://web-production-368e.up.railway.app']
